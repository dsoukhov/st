...
static char *defaultname = "st-256color";
...
const unsigned int defaultbg = 258;
const unsigned int defaultcs = 256;
const unsigned int defaultrcs = 257;
const unsigned int selectionbg = 258;
const unsigned int selectionfg = 259;
...
ResourcePref resources[] = {
  ...
  { "cursorRevColor",  STRING,  &colorname[defaultrcs] },
